...
//       if (tx.category != null && tx.category!.contains('/')) {
//         final parts = tx.category!.split('/');
//         _mainCategory = parts[0];
//         _subCategory = parts[1];
//       } else {
//         _mainCategory = tx.category ?? '';
//         _subCategory = '';
//       }
//     }
//   }
...
//                               final cat = mainCats[index];
//                               final isSelected =
//                                   _tempSelectedMainCategoryForSheet == cat;
//                               return ListTile(
//                                 tileColor: isSelected
//                                     ? AppColors.primary.withOpacity(0.2)
//                                     : null,
...
//                         VerticalDivider(color: AppColors.border, width: 1),
//                         Expanded(
//                           child: _tempSelectedMainCategoryForSheet.isEmpty
//                               ? Center(
//                                   child: Text('Select a main category first',
//                                       style: TextStyle(
//                                           color: AppColors.textSecondary)))
//                               : currentSubCategories.isEmpty
//                                   ? Center(
...
//                                         children: [
//                                           Text(
//                                               'No sub-categories for "$_tempSelectedMainCategoryForSheet"',
//                                               textAlign: TextAlign.center,
//                                               style: TextStyle(
//                                                   color:
//                                                       AppColors.textSecondary)),
...
//                     onTap: () {
//                       setModalState(() => _tempSelectedAccount = acc.name);
//                       setState(() => _account = _tempSelectedAccount);
//                       Navigator.pop(context);
//                     },
//                   );
...
//       if (_mainCategory.isEmpty || _account.isEmpty) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           const SnackBar(
...
//           note: _note,
//         );
//         await txNotifier.editTransaction(updatedTx);
//         if (mounted) {
//           ScaffoldMessenger.of(context).showSnackBar(
...
//           note: _note,
//         );
//         await txNotifier.addTransaction(newTx);
//         if (mounted) {
//           ScaffoldMessenger.of(context).showSnackBar(
//               const SnackBar(content: Text('Transaction added!')));
//           Navigator.pop(context);
            ...
            return SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    leading: Icon(_getAccountIcon(acc.type),
                        color: AppColors.primary),
                    title: Text(acc.name,
                        style: TextStyle(color: AppColors.textPrimary)),
                    subtitle: Text('Available: ₹${balance.toStringAsFixed(2)}',
                        style: TextStyle(
                            color: AppColors.textSecondary, fontSize: 12)),
                    trailing: isSelected
